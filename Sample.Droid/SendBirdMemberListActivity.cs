...
//		private List<User> mSelectedMembers;
...
//				mSelectedMembers = e.Members as List<User>;
...
//                        memberIds[i] = mSelectedMembers[i].UserId;
//					}
...
//				SendBirdClient.Connect(uuid, userName);
//			}
...
//				mMemberListQuery = SendBirdClient.QueryMemberList (mChannelUrl);
...
//			{
//				mSelectedMembers = new List<User>();
...
//			public class SendBirdMemberAdapter : BaseAdapter<User>
//			{
...
//					}
//				}
//				public void AddAll(List<User> members)
//				{
...
//					DisplayUrlImage(viewHolder.GetView<ImageView> ("img_thumbnail"), item.ProfileUrl);
//					viewHolder.GetView<TextView> ("txt_name").Text = item.Nickname;
