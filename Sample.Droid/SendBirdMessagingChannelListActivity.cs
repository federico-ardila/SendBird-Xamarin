...
//				SendBirdClient.Login (uuid, userName);
//				SendBirdClient.SetEventHandler (seh);
//			}
//		}
...
//		{
//			base.OnResume ();
//			var mMessageChannelListQuery = SendBirdClient.QueryMessagingList ();
...
//				}, null);
//			};
//			mMessageChannelListQuery.Next (); // Excute Query
//		}
...
//						mAdapter.NotifyDataSetChanged();
//						SendBirdClient.EndMessaging(messagingChannel.GetUrl());
//					});
//					builder.SetNeutralButton ("Hide", (sender_child, e_child) => {
//						mAdapter.Remove(e.Position);
//						mAdapter.NotifyDataSetChanged();
//						SendBirdClient.HideMessaging(messagingChannel.GetUrl());
//					});
...
//				if(member.id.Equals(SendBirdClient.GetUserId())) {
//					continue;
//				}
...
//					if (member.GetId ().Equals (SendBirdClient.GetUserId ())) {
//						continue;
//					}
